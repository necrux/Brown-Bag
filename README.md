...
Spin up a RHEL/CentOS 6 server with the 'rhel6_troubleshooting' from the cloud-init repo. This will automatically clone this repo onto the new server.<br><br>
