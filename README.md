...
9. As you go through the exercises run the scripts in /root/brown-bag/scenario* to configure the environment appropriately (scenario objectives are in the comments at the top of each script).<br>    More scenarios coming soon!
10. Profit!
